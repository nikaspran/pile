...
pub fn all_commands() -> Vec<CommandMetadata> {
    ...
    vec![
        ...
        CommandMetadata {
            command: SelectDocumentStart,
            name: "Select to Document Start",
            description: "Extend selection to the start of the document",
            category: Selection,
            shortcut: primary_shortcut(SelectDocumentStart),
        },
        CommandMetadata {
            command: SelectDocumentEnd,
            name: "Select to Document End",
            description: "Extend selection to the end of the document",
            category: Selection,
            shortcut: primary_shortcut(SelectDocumentEnd),
        },
        CommandMetadata {
            command: SelectLineStart,
            name: "Select to Line Start",
            description: "Extend selection to the start of the current line",
            category: Selection,
            shortcut: primary_shortcut(SelectLineStart),
        },
        CommandMetadata {
            command: SelectLineEnd,
            name: "Select to Line End",
            description: "Extend selection to the end of the current line",
            category: Selection,
            shortcut: primary_shortcut(SelectLineEnd),
        },
        CommandMetadata {
            command: SelectParagraphUp,
            name: "Select Paragraph Up",
            description: "Extend selection up by one paragraph",
            category: Selection,
            shortcut: primary_shortcut(SelectParagraphUp),
        },
        CommandMetadata {
            command: SelectParagraphDown,
            name: "Select Paragraph Down",
            description: "Extend selection down by one paragraph",
            category: Selection,
            shortcut: primary_shortcut(SelectParagraphDown),
        },
        CommandMetadata {
            command: SelectPageUp,
            name: "Select Page Up",
            description: "Extend selection up by one page",
            category: Selection,
            shortcut: primary_shortcut(SelectPageUp),
        },
        CommandMetadata {
            command: SelectPageDown,
            name: "Select Page Down",
            description: "Extend selection down by one page",
            category: Selection,
            shortcut: primary_shortcut(SelectPageDown),
        },
        // Selection expansion
        CommandMetadata {
            command: ExpandWord,
