...
impl From<NativeMenuCommand> for AppCommand {
    fn from(command: NativeMenuCommand) -> Self {
        match command {
            ...
            NativeMenuCommand::CheckForUpdates => Self::CheckForUpdates,
            NativeMenuCommand::RestartToUpdate => Self::RestartToUpdate,
...
impl AppCommand {
    pub(super) fn from_command(command: Command) -> Option<Self> {
        let app_command = match command {
            ...
            Command::CheckForUpdates => Self::CheckForUpdates,
            Command::RestartToUpdate => Self::RestartToUpdate,
